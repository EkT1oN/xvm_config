 ...
 */
{
  ...
  "def": {
    "al":   "0x00FF00",            // ally       / союзник
    "sq":   "0xFF8800",            // squadman   / взводный
    "tk":   "0x00FFFF",            // teamKiller / тимкиллер
    "en":   "0xFF0000",            // enemy      / противник
    "pl":   "0xFFFF00",            // player     / игрок
    "self": "0xDD00DD",            // self       / сам себе
    // Dynamic color by various statistical parameters.
    // Динамический цвет по различным статистическим показателям.
    "colorRating": {
      "very_bad":  "0xFF0000",     // very bad  / очень плохо
      "bad":       "0xFF8800",     // bad       / плохо
      "normal":    "0xFFFF00",     // normal    / средне
      "good":      "0x00FF00",     // good      / хорошо
      "very_good": "0x00FFFF",     // very good / очень хорошо
      "unique":    "0xFF00FF"      // unique    / уникально
    },
    ...
    "colorHP": {
      ...
      "average":       "0xFFFF00", // average       / средний
  ...
  "colors": {
    ...
    "system": {
      ...
      "teamKiller_dead":     "0x008888",
      "teamKiller_blowedup": "0x008888",
      "enemy_alive":         ${"def.en"},
      "enemy_dead":          "0x880000",
      "enemy_blowedup":      "0x880000",
      "player_alive":        ${"def.pl"},
      "player_dead":         "0x888800",
      "player_blowedup":     "0x888800"
    },
    // Dynamic color by damage kind.
    // Динамический цвет по типу урона.
    "dmg_kind": {
      "shot":            "0xFFAA44", // shot            / попадание
