...

{
  "hitLog": {
    ...
    "log": {
      ...
      "c:dmg-kind": {
        "shot": "#FFAA44",            // shot / попадание.
        "fire": "#FF4444",            // fire / пожар.
        "ramming": "#FFFF88",         // ramming / таран.
        "world_collision": "#008800", // world collision / столкновение с объектами, падение.
      ...
      "c:vtype": {
        "LT": "#00FF00",         // light tank / лёгкий танк.
        "MT": "#FFFF00",         // medium tank / средний танк.
        "HT": "#FF8F8F",         // heavy tank / тяжёлый танк.
        "SPG": "#DD00DD",        // SPG / САУ.
        "TD": "#00FFFF",         // tank destroyer / ПТ-САУ.
      ...
      "c:team-dmg": {
        "ally-dmg": "#00FFFF",  // ally / союзник.
        "enemy-dmg": "#CCCCCC", // enemy / противник.
        "player": "#DD00DD",    // self damage / урон по себе.
