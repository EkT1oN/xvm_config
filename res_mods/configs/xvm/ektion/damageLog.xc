  ...
  "damageLog": {
    ...
    "log": {
      ...
      "c:dmg-kind": {
        ...
        "fire": "0xff4444",                 // fire / пожар.
        "ramming": "0xffff88",              // ramming / таран.
        "world_collision": "0x008800",      // world collision / столкновение с объектами, падение.
        "drowning": "0xCCCCCC",             // drowning / утопление.
        "overturn": "0xCCCCCC",             // overturn / опрокидывание.
        "recovery": "0xCCCCCC",             // self-destruction / самоуничтожение (in the "Frontline" mode / в режиме "Линия фронта").
        "death_zone": "0xCCCCCC",           // death zone / смертельная зона.
        "gas_attack": "0xCCCCCC",           // gas attack / газовая атака.
      ...
      "c:type-shell": {
        "armor_piercing": "0xCCCCCC",      // armor piercing / бронебойный.
        "high_explosive": "0xCCCCCC",      // high explosive / осколочно-фугасный.
        "high_explosive_stun": "0xCCCCCC", // stunning high explosive / оглушающий осколочно-фугасный.
        "armor_piercing_cr": "0xCCCCCC",   // armor piercing composite rigid / бронебойный подкалиберный.
        "armor_piercing_he": "0xCCCCCC",   // armor piercing high explosive / бронебойно-фугасный.
        "hollow_charge": "0xCCCCCC",       // high explosive anti-tank / кумулятивный.
        "flame": "0xCCCCCC",               // flame / пламя. (Lesta)
        "armor_piercing_fsds": "0xCCCCCC", // armor piercing fin-stabilized discarding sabot / бронебойный подкалиберный оперенный. (Lesta)
        "not_shell": "0xCCCCCC"            // another source of damage / другой источник урона.
      },
      ...
      "c:vtype": {
        "LT": "0x00FF00",         // light tank / лёгкий танк.
        "MT": "0xFFFF00",         // medium tank / средний танк.
        "HT": "0xFF8F8F",         // heavy tank / тяжёлый танк.
        "SPG": "0xDD00DD",        // SPG / САУ.
        "TD": "0x00FFFF",         // tank destroyer / ПТ-САУ.
        "not_vehicle": "0xCCCCCC" // another source of damage / другой источник урона.
      },
      ...
      "c:hit-effects": {
        "armor_pierced": "0xFF4D3C",           // penetrated (damage) / пробито (урон).
        "intermediate_ricochet": "0xCCCCCC",   // ricochet (intermediate) / рикошет (промежуточный).
        "final_ricochet": "0xCCCCCC",          // ricochet / рикошет.
        "armor_not_pierced": "0xCCCCCC",       // not penetrated / не пробито.
        "armor_pierced_no_damage": "0xCCCCCC", // no damage / без урона.
        "armor_not_hit": "0xCCCCCC",           // no hit on the hull, turret and gun / нет попадания по корпусу, башне и орудию.
        "unknown": "0xCCCCCC"                  // unknown / неизвестно.
      },
      ...
      "c:team-dmg": {
        "ally-dmg": "0x00FFFF",  // ally / союзник.
        "enemy-dmg": "0xCCCCCC", // enemy / противник.
        "player": "0xDD00DD",    // self damage / урон по себе.
        "unknown": "0xCCCCCC"    // unknown / неизвестно.
      },
      ...
      "c:costShell": {
        "gold-shell":   "0xFFCC66", // gold / золото.
        "silver-shell": "0xCCCCCC", // credits / кредиты.
        "unknown":      "0xFFFFFF"  // unknown / неизвестно.
      },
      // Shadow settings.
      // Настройки тени.
      "shadow": {
