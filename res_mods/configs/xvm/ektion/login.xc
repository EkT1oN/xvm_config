  ...
  "login": {
    ...
    "pingServers": {
      ...
      "fontStyle": {
        ...
        "color": {
          "great": "#00FF00", // Отличный
          "good":  "#FFFF00", // Хороший
          "poor":  "#FF8800", // Так себе
          "bad":   "#FF0000"  // Плохой
        },
        // Color for server name and delimiter (for example, "#8080FF"). Empty string "" - use same color as online value.
        // Цвет для названия сервера и разделителя (например, "#8080FF"). Пустая строка "" - использовать цвет значения онлайна.
        "serverColor": "#FFFFFF"
      },
      ...
      "shadow": {
        ...
        "color": "#000000", // "#XXXXXX"     / color           / цвет
    ...
    "onlineServers": {
      ...
      "fontStyle": {
        ...
        "color": {
          "great": "#FFCC66", // Отличный
          "good":  "#E5E4E1", // Хороший
          "poor":  "#96948F", // Так себе
          "bad":   "#D64D4D"  // Плохой
        },
        // Color for server name and delimiter (for example, "#8080FF"). Empty string "" - use same color as online value.
        // Цвет для названия сервера и разделителя (например, "#8080FF"). Пустая строка "" - использовать цвет значения онлайна.
